...
- Run `npm run dev` to compile your plugin from `metadataStyleIndex.ts` to `main.js`.
- Make changes to `metadataStyleIndex.ts` (or create new `.ts` files). Those changes should be automatically compiled
  into `main.js`.
